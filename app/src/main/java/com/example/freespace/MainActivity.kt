...
class MainActivity : AppCompatActivity() {
    ...
    fun init(){
        ...
        add.setOnClickListener {
            ...
            val item = Place("스타벅스 건대입구", 30, 24, "스타벅스건대입구 정보")
            val item2 = Place("투썸플레이스 어린이대공원", 50, 26, "투썸플레이스 어린이대공원 정보")
            val item3 = Place("카페 온더플랜", 60, 30, "카페 온더플랜 정보")
            val item4 = Place("탑앤탐스 구의", 30, 29, "탑앤탐스 구의 정보")
            val item5 = Place("할리스커피 일감호", 25, 1, "할리스커피 일감호 정보")
            val item6 = Place("스타벅스 스타시티", 20, 10, "스타벅스 스타시티 정보")
